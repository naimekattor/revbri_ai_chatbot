...
export default function FrameworkSection() {
  ...
  return (
    <section className="w-full bg-white py-26 px-4 sm:px-6 lg:px-8 font-sans selection:bg-red-100 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 xl:gap-12 items-stretch">
        {/* Left Column: The Problem */}
        <div className="flex flex-col gap-6 justify-between">
          {/* Header Card */}
          <div className="bg-[#F8F8F8] border border-gray-100 rounded-xl p-4 text-left lg:text-right shadow-sm">
            <span className="text-[11px] font-bold tracking-wider text-primary uppercase block mb-1">
              The Problem
            </span>
            <h3 className="text-xl md:text-[20px] font-inter font-bold text-[#101828]">
            ...
            {leftColumnItems.map((item, idx) => (
              ...
              >
                ...
                <div className="text-left lg:text-right order-2 lg:order-1 flex-1">
                  <h4 className="text-base sm:text-lg font-bold text-[#101828] mb-0.5">
                    {item.title}
                  </h4>
                  <p className="text-xs sm:text-sm [#4A5565] leading-[27px] font-inter">
                    {item.description}
                  </p>
                </div>
        ...
        <div className="flex flex-col justify-center">
          <div className="bg-[#030303] text-white rounded-[28px] p-6 sm:p-10 lg:p-8 xl:p-8 text-center shadow-xl flex flex-col justify-center h-full py-12 lg:py-16">
            ...
            <div className="flex flex-col gap-2 sm:gap-4  py-4">
              ...
              <h2 className="text-2xl  md:text-3xl font-inter font-bold  uppercase break-words px-2">
                Insight
              </h2>
              <h2 className="text-2xl md:text-3xl  font-inter  font-bold  uppercase break-words px-2">
                Strategy
            ...
            {rightColumnItems.map((item, idx) => (
              ...
              >
                ...
                <div className="text-left flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-[#4A5565] leading-[27px] font-inter">
                    {item.description}
                  </p>
                </div>
              </div>
